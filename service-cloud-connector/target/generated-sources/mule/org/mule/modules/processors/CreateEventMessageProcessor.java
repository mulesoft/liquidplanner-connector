...
/**
 * CreateEventMessageProcessor invokes the {@link org.mule.modules.LiquidPlannerConnector#createEvent(java.lang.String, org.mule.LiquidPlanner.client.model.Event)} method in {@link LiquidPlannerConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedWorkSpaceId = ((String) evaluateAndTransform(getMuleContext(), event, CreateEventMessageProcessor.class.getDeclaredField("_workSpaceIdType").getGenericType(), null, workSpaceId));
            final Event _transformedEvent = ((Event) evaluateAndTransform(getMuleContext(), event, CreateEventMessageProcessor.class.getDeclaredField("_eventType").getGenericType(), null, event));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LiquidPlannerConnector) object).createEvent(_transformedWorkSpaceId, _transformedEvent);
                }
