    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedWorkSpaceId = ((String) evaluateAndTransform(getMuleContext(), event, CreateProjectMessageProcessor.class.getDeclaredField("_workSpaceIdType").getGenericType(), null, workSpaceId));
            final Project _transformedProject = ((Project) evaluateAndTransform(getMuleContext(), event, CreateProjectMessageProcessor.class.getDeclaredField("_projectType").getGenericType(), null, project));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LiquidPlannerConnector) object).createProject(_transformedWorkSpaceId, _transformedProject);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("createProject"), event, e);
        }
    }
