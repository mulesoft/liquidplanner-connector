...
/**
 * GetCustomFieldsMessageProcessor invokes the {@link org.mule.modules.LiquidPlannerConnector#getCustomFields(java.lang.String)} method in {@link LiquidPlannerConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.0", date = "2013-05-17T06:10:37-03:00", comments = "Build 3.4.0.1555.8df15c1")
public class GetCustomFieldsMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedWorkSpaceId = ((String) evaluateAndTransform(getMuleContext(), event, GetCustomFieldsMessageProcessor.class.getDeclaredField("_workSpaceIdType").getGenericType(), null, workSpaceId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LiquidPlannerConnector) object).getCustomFields(_transformedWorkSpaceId);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getCustomFields"), event, e);
        }
    }
