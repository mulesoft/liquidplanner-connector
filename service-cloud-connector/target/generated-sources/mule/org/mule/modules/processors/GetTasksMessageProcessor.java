...
/**
 * GetTasksMessageProcessor invokes the {@link org.mule.modules.LiquidPlannerConnector#getTasks(java.lang.String, java.util.List)} method in {@link LiquidPlannerConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedWorkSpaceId = ((String) evaluateAndTransform(getMuleContext(), event, GetTasksMessageProcessor.class.getDeclaredField("_workSpaceIdType").getGenericType(), null, workSpaceId));
            final List<Filter> _transformedFilters = ((List<Filter> ) evaluateAndTransform(getMuleContext(), event, GetTasksMessageProcessor.class.getDeclaredField("_filtersType").getGenericType(), null, filters));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LiquidPlannerConnector) object).getTasks(_transformedWorkSpaceId, _transformedFilters);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getTasks"), event, e);
        }
    }
