...
/**
 * DeleteTaskMessageProcessor invokes the {@link org.mule.modules.LiquidPlannerConnector#deleteTask(java.lang.String, java.lang.String)} method in {@link LiquidPlannerConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedWorkSpaceId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteTaskMessageProcessor.class.getDeclaredField("_workSpaceIdType").getGenericType(), null, workSpaceId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LiquidPlannerConnector) object).deleteTask(_transformedWorkSpaceId, _transformedTaskId);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("deleteTask"), event, e);
        }
    }
