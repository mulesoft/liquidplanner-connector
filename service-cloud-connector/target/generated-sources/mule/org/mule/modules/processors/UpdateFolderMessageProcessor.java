...
/**
 * UpdateFolderMessageProcessor invokes the {@link org.mule.modules.LiquidPlannerConnector#updateFolder(java.lang.String, org.mule.LiquidPlanner.client.model.Folder)} method in {@link LiquidPlannerConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedWorkSpaceId = ((String) evaluateAndTransform(getMuleContext(), event, UpdateFolderMessageProcessor.class.getDeclaredField("_workSpaceIdType").getGenericType(), null, workSpaceId));
            final Folder _transformedFolder = ((Folder) evaluateAndTransform(getMuleContext(), event, UpdateFolderMessageProcessor.class.getDeclaredField("_folderType").getGenericType(), null, folder));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LiquidPlannerConnector) object).updateFolder(_transformedWorkSpaceId, _transformedFolder);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updateFolder"), event, e);
        }
    }
