...
public class LiquidPlannerConnectorConfigDefinitionParser
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(LiquidPlannerConnectorConnectionManager.class.getName());
        builder.setScope(BeanDefinition.SCOPE_SINGLETON);
        setInitMethodIfNeeded(builder, LiquidPlannerConnectorConnectionManager.class);
        setDestroyMethodIfNeeded(builder, LiquidPlannerConnectorConnectionManager.class);
